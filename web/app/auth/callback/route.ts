...
//
// When EXTENSION_ID is set, ALL logins (web + extension) land on the
// extension-callback page. That page checks localStorage to decide whether
// to send the token to the Chrome extension (extension login) or redirect
// to /dashboard (web login). See extension-callback/page.tsx.
//
